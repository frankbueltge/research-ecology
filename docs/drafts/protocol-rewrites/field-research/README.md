...
draft / audit trail. The live README has since evolved (site routes updated, e.g.
/lab → /holdings, 2026-07-24); do not re-apply this file verbatim. -->
...
with AI — [the lab](https://frankbueltge.de/lab).

- **The standing instruction:** [`PROTOCOL.md`](./PROTOCOL.md)
- **The field-map seed:** [`FIELD.md`](./FIELD.md)
- **What it can build in the lab:** [`SITE-API.md`](./SITE-API.md)
- **Team channel:** [`REQUESTS.md`](./REQUESTS.md)
- **Journal:** `journal/` · **Works:** `works/`

The works become visible in the lab on frankbueltge.de. This repository is the collective's memory
